                        ...
                        { 
                            if($model->application_current_status_id == 2){
                                ...
                                return '<div class="btn-group-vertical">
                                            <a href="' .URL::to('candidate/' . $model->candidate_user_id).'" target="_blank" style="width:8.5em;" class="btn  btn-warning">
                                ...
                                return '<div class="btn-group-vertical">
                                            ...
                                            <a href="' .URL::to('candidate/' . $model->candidate_user_id). '" target="_blank" type="button" class="btn btn-success">
                                                <i class="fa fa-fw fa-info-circle"></i> Detail
                                            </a>
                                        </div>';
                            }
                                ...
                                //return '<a href="' .URL::to('candidate/' . $model->candidate_user_id).'"><button class="btn btn-sm btn-warning">Detail</button></a>';
                                return '<div class="btn-group-vertical">
                                            <a href="' .URL::to('candidate/' . $model->candidate_user_id).'" style="width:8.5em;" class="btn btn-success"><i class="fa fa-fw fa-info-circle"></i> Detail</a>
                                        </div>
                                        ';
                            }
                        });
