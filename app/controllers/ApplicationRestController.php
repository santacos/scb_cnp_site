        ...
        // return $user_id.'----'.$status_id;
                   ...
                   $req=$req->get();
                    ...
                    ->addColumn('Education',function($model)
                        { return $model->candidate()->first()->Education()->last()->level.' '.$model->candidate()->first()->Education()->last()->major.' '.$model->candidate()->first()->Education()->last()->field_of_study;
                        })
                    ...
                    ->addColumn('Choose',function($model)
                        { 
                            return '<center>'
                                                    .'<iframe width="30px" height="20px" scrolling="no" frameBorder="0" name="ckbox_f'.$model->application_id.'" id="ckbox_f'.$application->application_id.'">'
                                                    .'</iframe>'
                                                    .'</center>'
