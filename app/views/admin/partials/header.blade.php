		...
		<div class="navbar-right">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown messages-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-envelope"></i> <span class="label label-success">90</span> </a>
					<ul class="dropdown-menu">
						<li class="header">
							You have 4000 messages
						</li>
						<li>
							...
							<ul class="menu">
								...
								<li>
									...
									</div> <h4> Developer <small><i class="fa fa-clock-o"></i> 3 days</small></h4>
									<p>
										I'm gay. EiEi EuEu kiki
									</p> </a>
								</li>
							</ul>
						</li>
				...
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span>Jane Doe <i class="caret"></i></span> </a>
					<ul class="dropdown-menu">
						<!-- User image -->
